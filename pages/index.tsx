      ...
      <div>
        <div className={styles.home__cta}>
          ...
          <p>
            ...
            <br /> Stats, images, and other functionality are intentionally omitted for others to interpret.<br/>If you were not lucky enough with Loot on Ethereum, let's feel free to use Polygon Loot in any
            way you want.
          </p>
        </div>
